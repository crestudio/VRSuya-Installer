				...
				if (TargetAnimator) {
					foreach (PhysBoneConnector TargetComponent in PhysBoneConnectors) {
						...
						if (TargetComponent.TargetType == PhysBoneType.Cheek) {
							string[] Cheek_L_Names = new string[] { "Cheek.L", "Cheek1_L", "Cheek_Root_L", "Cheek_root_L", "Hoppe.L", "ho_L" };
							string[] Cheek_R_Names = new string[] { "Cheek.R", "Cheek1_R", "Cheek_Root_R", "Cheek_root_R", "Hoppe.R", "ho_R" };
