...
namespace com.vrsuya.installer {
	...
	public class LanguageHelper : AvatarSettingUpdaterEditor {
		...
		internal static string[] ReturnAvatarName(SerializedProperty AvatarNameListProperty) {
			int AvatarNameCount = AvatarNameListProperty.arraySize;
			AvatarSettingUpdater.Avatar[] InstalledVRSuyaProductAvatars = new AvatarSettingUpdater.Avatar[AvatarNameCount];
			...
			return InstalledVRSuyaProductAvatars
				.Where((AvatarName) => dictAvatarNames.ContainsKey(AvatarName))
				.Select((AvatarName) => dictAvatarNames[AvatarName][LanguageIndex])
				.ToArray();
		}
		...
		static readonly Dictionary<AvatarSettingUpdater.Avatar, string[]> dictAvatarNames = new Dictionary<AvatarSettingUpdater.Avatar, string[]>() {
			...
			{ AvatarSettingUpdater.Avatar.Chise, new string[] { "Chise", "치세", "チセ" } },
			...
			{ AvatarSettingUpdater.Avatar.Eku, new string[] { "Eku", "에쿠", "エク" } },
			...
			{ AvatarSettingUpdater.Avatar.Flare, new string[] { "Flare", "플레어", "フレア" } },
			...
			{ AvatarSettingUpdater.Avatar.KUMALY, new string[] { "KUMALY", "쿠마리", "クマリ" } },
			...
			{ AvatarSettingUpdater.Avatar.Lazuli, new string[] { "Lazuli", "라줄리", "ラズリ" } },
			...
			{ AvatarSettingUpdater.Avatar.LUMINA, new string[] { "LUMINA", "루미나", "ルミナ" } },
			{ AvatarSettingUpdater.Avatar.Lunalitt, new string[] { "Lunalitt", "루나릿트", "ルーナリット" } },
			{ AvatarSettingUpdater.Avatar.Mafuyu, new string[] { "Mafuyu", "마후유", "真冬" } },
			...
			{ AvatarSettingUpdater.Avatar.Nehail, new string[] { "Nehail", "네하일", "ネハイル" } },
			{ AvatarSettingUpdater.Avatar.Nochica, new string[] { "Nochica", "노치카", "ノーチカ" } },
			{ AvatarSettingUpdater.Avatar.Platinum, new string[] { "Platinum", "플레티늄", "プラチナ" } },
			{ AvatarSettingUpdater.Avatar.Plum, new string[] { "Plum", "플럼", "プラム" } },
			{ AvatarSettingUpdater.Avatar.Pochimaru, new string[] { "Pochimaru", "포치마루", "ぽちまる" } },
			{ AvatarSettingUpdater.Avatar.Quiche, new string[] { "Quiche", "킷슈", "キッシュ" } },
			{ AvatarSettingUpdater.Avatar.Rainy, new string[] { "Rainy", "레이니", "レイニィ" } },
			{ AvatarSettingUpdater.Avatar.Ramune, new string[] { "Ramune", "라무네", "ラムネ" } },
			...
			{ AvatarSettingUpdater.Avatar.Rokona, new string[] { "Rokona", "로코나", "ロコナ" } },
			{ AvatarSettingUpdater.Avatar.Rue, new string[] { "Rue", "루에", "ルウ" } },
			{ AvatarSettingUpdater.Avatar.Rurune, new string[] { "Rurune", "루루네", "ルルネ" } },
			...
			{ AvatarSettingUpdater.Avatar.SHIRAHA, new string[] { "SHIRAHA", "시라하", "シラハ" } },
			{ AvatarSettingUpdater.Avatar.Shiratsume, new string[] { "Shiratsume", "시라츠메", "しらつめ" } },
			...
			{ AvatarSettingUpdater.Avatar.VIVH, new string[] { "VIVH", "비브", "ビィブ" } },
